...
namespace API.Data.migrations
{
    ...
    [Migration("20241114115802_FitnessPlanTemplateNamingFix")]
    partial class FitnessPlanTemplateNamingFix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Data.AppUserBase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Data.AppMember", b =>
                {
                    b.HasBaseType("API.Data.AppUserBase");
            ...
            modelBuilder.Entity("API.Data.AppTrainer", b =>
                {
                    b.HasBaseType("API.Data.AppUserBase");
            ...
            modelBuilder.Entity("API.Data.BodyWeight", b =>
                {
                    b.HasOne("API.Data.AppMember", "User")
                        .WithOne("BodyWeight")
            ...
            modelBuilder.Entity("API.Data.FitnessPlanTemplate", b =>
                {
                    b.HasOne("API.Data.AppTrainer", "Author")
            ...
            modelBuilder.Entity("API.Data.Message", b =>
                {
                    b.HasOne("API.Data.AppUserBase", "Receiver")
                        .WithMany("MessagesReceived")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("API.Data.AppUserBase", "Sender")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("API.Data.AppUserBase", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
